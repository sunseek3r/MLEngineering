...
class MLflowConfig:
    ...
    experiment_name: str = "lab4-cifar10"
    auto_start_run: bool = True
    run_name: str = "standalone-training"
...
def load_config(config_path: str | Path) -> AppConfig:
    ...
    mlflow_values = _merge_dataclass_defaults(MLflowConfig().__dict__, mlflow_raw)
    ...
    return AppConfig(
        ...
        mlflow=MLflowConfig(**mlflow_values),
